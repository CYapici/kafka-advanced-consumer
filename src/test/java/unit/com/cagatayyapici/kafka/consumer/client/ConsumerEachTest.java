...
import com.cagatayyapici.kafka.consumer.ConsumerEach;
...
/**
 * The class <code>ConsumerIterateTest</code> contains tests for the class 
 *
 * 
 * @author cagatayyapici
 * 
 */
public class ConsumerEachTest extends Parameters {
	/**
